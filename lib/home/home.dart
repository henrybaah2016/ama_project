  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('AMA',style: TextStyle(color: Color(0xff3d3c3d), fontSize: 20, fontWeight: FontWeight.w600,),),
                      ...
                      child: Container(
                        ...
                        child: new GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => RegisterBillboard()),
                            );
                          },
                          child: Container(
                            child: Row(
                      ...
                      child: Container(
                        ...
                        child: new GestureDetector(
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => VerifyBillboard()),
                            );
                          },
                          child: Container(
                            child: Row(
